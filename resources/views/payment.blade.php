<x-app-layout>
    ...
    <div class="dashboard-bg py-7 pl-7 pr-4 w-full">
        ...
        <div class="w-full flex gap-4">
            <div class="w-3/4 bg-white border border-gray-300 mr-6 relative">
                ...
                <div class="flex absolute top-38 left-96 transform translate-x-1 -translate-y-14">
                ...
                <div class="p-4">
                    ...
                    <div class="flex items-center">
                        <span class="pr-4 text-gray-300">1</span>
            ...
            {{-- profit share payments page --}}

        <div class="w-1/4 bg-white border border-gray-300 p-5">
            <div class="flex">
                <div class=" w-1/2">
            ...
            <div class="flex pt-3">
                <div class="w-1/2">
                    ...
                    <div>
                        ...
                        <p class="text-blue-600 text-sm">+ 1,0% <span class="text-gray-400">from last month</span>
                        </p>
